...
- In progress: Local CLI Companion (`docs/companion.md`) — API key proxy MVP and baseline security hardening done; next up: keychain evaluation and install/upgrade docs
