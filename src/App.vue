...
<template>
  <main class="flex h-screen bg-white text-gray-900 antialiased">
    ...
    <ChatWorkspace
      ...
      :pending-job-count="studio.chat.pendingJobCount"
      :quality-label="studio.chat.qualityLabel"
      :quality-options="studio.chat.qualityOptions"
      :size-label="studio.chat.sizeLabel"
      :size-ratio-options="studio.chat.sizeRatioOptions"
      :size-resolution="studio.chat.sizeResolution"
      :size-resolution-options="studio.chat.sizeResolutionOptions"
      @apply-size-preset="studio.chat.applySizePreset"
      @apply-size-resolution="studio.chat.applySizeResolution"
