...
<template>
  <main class="flex h-screen bg-white text-gray-900 antialiased">
    ...
    <SettingsModal
      ...
      :companion-online="studio.settingsModal.companionOnline"
      :companion-health="studio.settingsModal.companionHealth"
      :companion-auth-status="studio.settingsModal.companionAuthStatus"
      :companion-pairing-in-progress="studio.settingsModal.companionPairingInProgress"
      :companion-pairing-error="studio.settingsModal.companionPairingError"
      v-model:companion-pairing-code-input="studio.settingsModal.companionPairingCodeInput"
      ...
      @check-status="studio.settingsModal.checkCompanionStatus"
      @start-pairing="studio.settingsModal.startCompanionPairing"
      @confirm-pairing="studio.settingsModal.confirmCompanionPairing"
      @disconnect-companion="studio.settingsModal.disconnectCompanion"
      @cancel-pairing="studio.settingsModal.cancelCompanionPairing"
