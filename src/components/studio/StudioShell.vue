...
<template>
  ...
  >
    ...
    <SettingsModal
      ...
      :model="studio.settingsModal.model"
      :model-options="studio.settingsModal.modelOptions"
      :models-probe="studio.settingsModal.modelsProbe"
      @update:model="studio.settingsModal.setModel"
      @probe-models="studio.settingsModal.probeModels"
